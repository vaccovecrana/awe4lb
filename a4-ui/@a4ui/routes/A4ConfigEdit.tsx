...
import { A4IcnSave } from "@a4ui/components/A4Icons"
    ...
    return (
      <div>
        ...
        <div class="mt16">
          ...
          <div class="row">
            <div class="col auto">
              <textarea class="editor" rows={32} onChange={(e) => this.onEdit(e)}>
